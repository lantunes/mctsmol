...
if __name__ == '__main__':
    ...
    for i in range(0, trials):
        ...
        mcts = MolecularMCTS3f(allowed_angle_values, energy_function, c=c)
        ...
        497/279936 -> 73.98046 (0.18%)
          ...
          c=3, n=300, PUCT:
            best energies mean: 74.00763
            best energies min: 73.98046
            global min times found: 71/100
          c=sqrt(2), n=300, UCB1:
            best energies mean: 74.00318
            best energies min: 73.98046
            global min times found: 77/100
            run #2:
            best energies mean: 74.00455
            best energies min: 73.98046
            global min times found: 76/100
        """
